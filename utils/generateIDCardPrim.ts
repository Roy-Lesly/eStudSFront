...
export const generateIDCardPrim = async (
    ...
    for (let i = 0; i < students.length; i++) {
        ...
        pdf.text(`Date Of Birth:`, x + 29, y + 30);
        pdf.text(`Date de N.:`, x + 29, y + 32.3);
        pdf.text(`Class:`, x + 29, y + 37);
        pdf.text(`Classe:`, x + 29, y + 39.5);
        ...
        pdf.text(`${student.dob}`, x + 50, y + 31);
        const specialtyText = pdf.splitTextToSize(`${student.specialty.slice(0, 30)}`, 41);
        pdf.text(specialtyText, x + 50, y + 39);
