    ...
    if (type === "SchoolFees") {
        response = edges?.map((edge: EdgeSchoolFees, index: number) => {
            ...
            return {
                ...
                Parent: node?.userprofile?.customuser?.parent,
                "Parent Telephone": node?.userprofile?.customuser?.parentTelephone,
    ...
    if (type === "UserProfile") {
        response = edges?.map((edge: EdgeUserProfile, index: number) => {
            ...
            return {
                ...
                Parent: node?.customuser?.parent,
                "Parent Telephone": node?.customuser?.parentTelephone,
