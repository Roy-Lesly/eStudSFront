...
export const GroupUrl = RootApi + "/higher/higher_user_control/group"
export const PermissionUrl = RootApi + "/higher/higher_user_control/permission"
export const ProgramUrl = RootApi + "/higher/higher_user_control/program"
export const AppearanceUrl = RootApi + "/higher/higher_user_control/appearance"
export const UserActivityUrl = RootApi + "/higher/higher_user_control/useractivity"
...
export const GetDepartmentUrl = RootApi + "/higher/higher_user_control/get-department"
export const GetAppearanceUrl = RootApi + "/higher/higher_user_control/get-appearance"
export const GetProgramUrl = RootApi + "/higher/higher_user_control/get-program"

export const CheckPasswordUrl = RootApi + "/higher/higher_user_control/check-password"
export const CreatePasswordUrl = RootApi + "/higher/higher_user_control/create-password"
