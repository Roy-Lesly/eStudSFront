...
import ModalTransaction from '@/app/[locale]/[domain]/Section-S/pageAdministration/[school_id]/pageStudents/[student_id]/Comps/ModalTransaction';

const ActivationErrorSec = (
  { type, item, link, fees }
    :
    { type: 'platform' | 'id' | "fees", fees: NodeSchoolFeesSec, item?: string, link?: string }
) => {
...
export default ActivationErrorSec;
