...
import ModalTransaction from '@/[locale]/[domain]/Section-H/pageAdministration/[school_id]/pageStudents/[student_id]/Comps/ModalTransaction';

const ActivationError = (
  { type, item, link, fees }
    :
    { type: 'platform' | 'id' | "fees", fees: EdgeSchoolFees, item?: string, link?: string }
) => {
