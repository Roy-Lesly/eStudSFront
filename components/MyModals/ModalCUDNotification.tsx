...
//     const optionLevels = apiLevels?.map((l: EdgeLevel) => { return { value: decodeUrlID(l.node.id), label: l.node.level } });
//     const optionSpecialties = apiLevels?.map((l: EdgeLevel) => { return { value: decodeUrlID(l.node.id), label: l.node.level } });
