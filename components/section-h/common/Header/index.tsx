...
import DropdownUser from "@/section-h/Header/DropdownUser";
...
const Header = (props: {
  ...
  return (
    <header className="bg-white dark:bg-boxdark dark:drop-shadow-none drop-shadow-1 flex sticky top-0 w-full z-999">
      <div className="2xl:px-11 flex flex-grow items-center justify-between md:px-6 px-4 py-4 shadow-2">
        ...
        <div className="hidden sm:block">
          <form action="https://formbold.com/s/unique_form_id" method="POST">
            <div className="relative">
              <button className="-translate-y-1/2 absolute left-0 top-1/2">
                <svg
                  className="dark:fill-bodydark dark:hover:fill-primary fill-body hover:fill-primary"
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
                  fill="none"
              ...
              <input
                ...
                className="bg-transparent focus:outline-none font-medium pl-9 pr-4 w-full xl:w-125"
              />
            </div>
          </form>
        </div>
