...
const SidebarAdmin = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={SidebarProc}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black dark:bg-boxdark duration-300 ease-linear lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="duration-300 ease-linear flex flex-col flex-grow no-scrollbar overflow-y-auto">
        {/* <!-- SidebarProc Menu --> */}
        <nav className="lg:mt-4 lg:px-6 px-4 py-4">
          {/* <!-- Menu Group --> */}
          <div>
      ...
      <div className="flex font-medium items-center justify-center my-2 text-center text-white tracking-widest">Powered by Econneq</div>
