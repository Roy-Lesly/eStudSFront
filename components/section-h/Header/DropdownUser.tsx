  ...
  return (
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      >
        ...
        <span className="h-12 rounded-full w-12">
          <Image
            width={112}
            height={112}
      ...
      {dropdownOpen && (
        ...
        >
          <ul className="border-b border-stroke dark:border-strokedark flex flex-col gap-5 px-6 py-7.5">
          ...
          <button
            ...
            className="duration-300 ease-in-out flex font-medium gap-3.5 hover:text-primary items-center lg:text-base px-6 py-4 text-sm"
          >
            <svg
              className="fill-current"
              width="22"
      ...
      {showSignOut && <ConfirmLogout showSignOut={showSignOut} setShowSignOut={setShowSignOut} />}
