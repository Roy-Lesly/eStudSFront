...
const ListFieldPage = ({ params, data, apiDomains }: { params: any, data: GetFieldInter[] | any, apiDomains: string[] }) => {
      ...
      <td>
        <div className="flex gap-2 items-center">
          ...
          <button className="field-blue-300 flex h-7 items-center justify-center rounded-full w-7">
            <FormModal table="field" type="delete" params={params} data={item} icon={<RiDeleteBin2Line />} />
          </button>
        </div>
      </td>
    </tr>
    ...
    <div className="bg-white flex-1 m-2 mt-1 p-2 rounded-md">
      ...
      <div className="flex flex-col gap-4 items-center justify-between mb-2 md:flex-row md:gap-2">
        <div className="flex gap-2 items-center w-full">
          ...
          {/* <TableSearch placeholder="By Field Name" searchString="field_name" /> */}
          <TableSearchSelect searchString="domain__domain_name" objectData={apiDomains} field="domain_name" />
