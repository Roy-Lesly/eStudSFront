...
const PasswordResetModal = (
    { action, onClose, id }
        :
        { action: "reset" | "change" | null, onClose: any, id: number }
) => {
                ...
                >
                    ...
                    >
                        <h2 className="text-2xl font-bold mb-1">
                            {action === "reset" ? "Reset Password" : "Change Password"}
                        </h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <button type="submit" className="rounded border px-5 py-2 bg-green-500 text-white font-semibold rounded-lg tracking-wider" disabled={loading}>
