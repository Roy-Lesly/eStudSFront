...
const IDComp1 = ({ data, params }: { data: EdgeSchoolFees[], params: any, searchParams: any }) => {
...
return (
    <div>
      {!fetchedData ? (
        ...
        <BlobProvider
          document={<IDPDFs fetchedData={fetchedData} params={params} />}
        >
          {({ url, loading }) => (
            loading
...
export default IDComp1;


const IDPDFs = (
  { fetchedData, params }: 
  { fetchedData: EdgeSchoolFees[] | null, params: any }
) => {
  ...
  return <Document>
    ...
    >
            ...
            <View style={[styles.body, { height: "78%", paddingTop: 1.5 }]}>
              ...
              <View style={[styles.right, { paddingTop: 3, gap: 3.5, paddingHorizontal: 0.7 }]}>
                ...
                <View style={[styles.info, {}]}>
                  ...
                  <Text style={[styles.subBodyText, { textAlign: "center", width: "68%", fontSize: 9 }]}>{studentData.node.userprofile.customuser.fullName}</Text>
                </View>
                ...
                <View style={[styles.info, { marginVertical: 0.5 }]}>
                  ...
                  <Text style={[{ fontSize: 10, fontWeight: "heavy", textAlign: "center", width: "67%" }]}>{studentData.node.userprofile.customuser.matricle}</Text>
                </View>
                ...
                <View style={[styles.info, {}]}>
                  ...
                  <Text style={[{ fontSize: 8, fontWeight: "bold", textAlign: "center", width: "60%", }]}>{studentData.node.userprofile.customuser.dob} - {studentData.node.userprofile.customuser.pob}</Text>
                </View>
      ...
      {fetchedData?.length === 1 && fetchedData?.map((studentData: EdgeSchoolFees, index: number) => (
        <View key={index} style={[styles.containerSin, { width: "100%" }]}>
