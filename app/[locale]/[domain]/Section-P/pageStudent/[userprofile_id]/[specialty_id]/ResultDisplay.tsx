...
// import { calcTotalandGrade, capitalizeFirstLetter } from '@/functions';
...
//   const schoolFeesPrim: NodeSchoolFeesPrim = data ? data.allSchoolFees?.edges[0].node : null
...
//   const pubI: EdgePublishPrim[] = data && data.allPublishes.edges?.filter((item: EdgePublish) => item?.node.semester === "I")
//   const pubII: EdgePublishPrim[] = data && data.allPublishes.edges?.filter((item: EdgePublish) => item?.node.semester === "II")
...
//     { schoolFees: NodeSchoolFeesPrim, data: EdgeResultPrimary[], examPublished: boolean, resitPublished: boolean, semester: "I" | "II", locale: string }
// ) => {
