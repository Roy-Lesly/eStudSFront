...
import { EdgeSchoolFees, EdgeSchoolInfoHigher } from '@/Domain/schemas/interfaceGraphql';
...
const List = ({ p, data, sp, school }: { p: any; data: EdgeSchoolFees[], sp: any, school: EdgeSchoolInfoHigher }) => {
