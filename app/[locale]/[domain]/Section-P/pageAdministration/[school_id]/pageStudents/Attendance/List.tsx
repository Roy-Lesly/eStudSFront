...
const List = (
  ...
  const Columns: TableColumn<EdgeClassRoomPrim>[] = [
    { header: "#", align: "center", render: (_item: EdgeClassRoomPrim, index: number) => index + 1, },
    {
      header: `${t("Class")}`, align: "left", render: (item: EdgeClassRoomPrim) => <div className='flex justify-between gap-2 items-center'>
    ...
    { header: `${t("Students")}`, accessor: "node.studentCount", align: "center" },
    {
      ...
      >
        <div className='flex flex-row gap-2'>
          <button
            onClick={() => router.push(`/${params.domain}/Section-P/pageAdministration/${params.school_id}/pageStudents/Attendance/${item.node.id}`)}
  ...
  return (
    <DefaultLayout
      ...
      searchComponent={
        <SearchMultiple
          names={['level', 'stream']}
          link={`/${params.domain}/Section-P/pageAdministration/${params.school_id}/pageStudents/Attendance`}
          select={[
