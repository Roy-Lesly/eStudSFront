  ...
  useEffect(() => {
    ...
    const fetchImagesSequentially = async () => {
      ...
      for (const studentData of data) {
        try {
          const logoUrl = `https://api${params.domain}.e-conneq.com/media/${studentData?.node.userprofile?.specialty?.school?.logoCampus}`;
          ...
          await Promise.all([fetch(logoUrl), fetch(profilePicUrl)]);
