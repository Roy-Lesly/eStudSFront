...
import AdmissionPrintHigher from "./AdmissionPrintHigher";


const AdmissionFormHigher = ({
  data, p
}: {
  ...
  useEffect(() => {
    ...
    const url = `${protocol}${p.domain}${RootApi}/check/${data?.node?.id}/H/admission`;
...
export default AdmissionFormHigher;
