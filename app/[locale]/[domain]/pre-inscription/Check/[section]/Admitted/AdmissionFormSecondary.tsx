...
import AdmissionPrintSecondary from "./AdmissionPrintSecondary";


const AdmissionFormSecondary = ({
  data, p
}: {
  ...
  useEffect(() => {
    ...
    const url = `${protocol}${p.domain}${RootApi}/check/${data?.node?.id}/S/admission`;
...
export default AdmissionFormSecondary;
