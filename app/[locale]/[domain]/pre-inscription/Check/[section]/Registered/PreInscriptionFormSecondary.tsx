...
import PreInscriptionPrintSecondary from "./PreInscriptionPrintSecondary";



const PreInscriptionFormSecondary = ({
  p,
  data,
  dataMainSpecialties,
  dataSchool
...
export default PreInscriptionFormSecondary;
