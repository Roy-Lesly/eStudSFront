...
import PreInscriptionPrintHigher from "./PreInscriptionPrintHigher";

const PreInscriptionFormHigher = ({
  p,
  data,
  dataMainSpecialties,
  dataSchool
  ...
  useEffect(() => {
    ...
    const url = `${protocol}${p.domain}${RootApi}/check/${data?.node?.id}/H/preinscription`;
...
export default PreInscriptionFormHigher;
