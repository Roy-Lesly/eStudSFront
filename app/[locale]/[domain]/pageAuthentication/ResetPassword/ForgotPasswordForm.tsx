    ...
    return (
        <>
            <div className="flex flex-col items-center mb-6">
                ...
                <h1 className="text-xl text-teal-300 font-bold mt-6 text-center my-2">{t("FORGOTTEN PASSWORD")}</h1>

                <span className='text-center mt-2 italic'>{t("Enter Email of your Account")}</span>
