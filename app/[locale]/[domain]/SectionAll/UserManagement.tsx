...
const UserManagement = (
    { searchParams, params, dataExtra }:
        { params: any, searchParams: any, dataExtra: any }
) => {
    ...
    return (
        <div>
            <motion.div
                ...
                className="p-2 md:p-4 bg-white shadow-md rounded-lg"
            >
...
const GET_DATA = gql`
    query GetData (
        ...
        allCustomusers (
            ...
            edges {
                node {
                    id matricle firstName lastName fullName address telephone
                    role email isActive isStaff isSuperuser isHod
                    page { 
                        edges {
                            node { 
                                id name
