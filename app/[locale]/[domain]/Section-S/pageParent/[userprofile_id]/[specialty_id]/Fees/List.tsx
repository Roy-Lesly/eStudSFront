...
import { EdgeMoratoire, EdgeSchoolFees, EdgeTransactions } from '@/Domain/schemas/interfaceGraphql';
...
const List = (
  { p, apiSchoolFees, apiTransactions, apiMoratoires }:
  { apiSchoolFees: EdgeSchoolFees, apiTransactions: EdgeTransactions[], apiMoratoires: EdgeMoratoire, p?: any }
) => {
