...
const page = async (
  ...
  const menuList = [
    { id: 1, link: "", label: `${t("Back")}`, icon: "/images/ca.svg", notification: false },
    // { id: 2, link: "Announcements", label: `${t("Announcements")}`, icon: "/images/ca.svg", notification: false },
    { id: 3, link: "Complains", label: `${t("Complains")}`, icon: "/images/resit.svg", notification: false },
]
