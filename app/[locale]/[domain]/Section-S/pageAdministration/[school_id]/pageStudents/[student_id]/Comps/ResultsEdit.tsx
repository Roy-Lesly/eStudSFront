...
import { EdgeResultSecondary, TableColumn } from '@/utils/Domain/schemas/interfaceGraphqlSecondary';
...
const ResultsEdit = ({ data, canEdit, params, selectedTerm }: { data: EdgeResultSecondary[], canEdit: boolean, params: any, selectedTerm: string }) => {
    ...
    const Columns: TableColumn<EdgeResultSecondary>[] = [
        ...
        },
        {
            ...
            accessor: 'node.subjectsec.mainsubject.subjectName',
            align: 'left',
        },
        {
            header: 'Results',
    ...
    const defaultFormData = data.map((item: EdgeResultSecondary) => {
        ...
        return {
            ...
            node: {
                id: item.node.id,
                subjectsec: item.node.subjectsec,
        ...
        <div>
            {data.length < 1 ?
                ...
                <div className='flex items-center justify-center w-full'>
                    <MyTableComp
                        columns={Columns}
                        data={formData.sort((a: EdgeResultSecondary, b: EdgeResultSecondary) => a.node.student.customuser.fullName > b.node.student.customuser.fullName ? 1 : a.node.student.customuser.fullName < b.node.student.customuser.fullName ? -1 : 0)}
...
mutation Result(
    ...
    createUpdateDeleteResultSec(
        ...
        resultsec {
            id
            subjectsec { mainsubject {subjectName}}
