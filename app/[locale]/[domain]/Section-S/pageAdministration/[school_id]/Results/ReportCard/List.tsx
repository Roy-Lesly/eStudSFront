...
const List = ({ params, data }: { params: any; data: any }) => {
  ...
  return (
        ...
        <Header
          ...
          searchComponent={
            <SearchMultiple
              ...
              link={`/${params.domain}/Section-S/pageAdministration/${params.school_id}/ReportCard`}
            />
          }
        />
      }
    >
      <Breadcrumb
        department="ReportCard"
        subRoute="List"
        pageName="ReportCard"
        mainLink={`${params.domain}/Section-S/pageAdministration/${params.school_id}/Results/ReportCard/`}
        subLink={`${params.domain}/Section-S/pageAdministration/${params.school_id}/Results/ReportCard/`}
      />
