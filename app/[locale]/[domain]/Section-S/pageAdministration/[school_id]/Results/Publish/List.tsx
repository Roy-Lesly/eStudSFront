  ...
  return (
        ...
        <Header
          ...
          searchComponent={
            <SearchMultiple
              ...
              link={`/${params.domain}/Section-S/pageAdministration/${params.school_id}/Results/Publish`}
            />
          }
        />
      }
    >
      <Breadcrumb
        ...
        subRoute="List"
        pageName="Publish"
        mainLink={`${params.domain}/Section-S/pageAdministration/${params.school_id}/Results/Publish/`}
        subLink={`${params.domain}/Section-S/pageAdministration/${params.school_id}/Results/Publish/`}
      />
  ...
  return (
    <div className="border overflow-x-auto relative w-full">
              ...
              >
                ...
                <td className="px-1 py-2 text-left w-1/3">
                  <div className="flex flex-row gap-2 md:gap-10">
                    {item.node.publishSeq ? (
                      Object.keys(parseJson(item.node.publishSeq)).map((seqKey) => (
                        <div key={seqKey} className="flex gap-1 items-center">
                          {parseJson(item.node.publishSeq)[seqKey] ? (
      ...
      {dataUpdate && openModal ?
        <Modal params={params} dataUpdate={dataUpdate} setOpenModal={setOpenModal} type="publish" />
        :
        null
      }
    </div>
