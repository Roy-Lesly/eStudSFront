    ...
    >
      <div className="bg-gray-50 flex flex-col items-center justify-center">
        ...
        {data ? (
          ...
          <MyTabs
            tabs={[
              { label: `${t('Student Management')}`, content: data.studs?.allCustomusers?.edges.length ? <DataComp data={data.studs.allCustomusers.edges} title="Students" /> : <ServerError type="notFound" item={t("Student Users")} /> },
            ]}
            activeTab={activeTab}
