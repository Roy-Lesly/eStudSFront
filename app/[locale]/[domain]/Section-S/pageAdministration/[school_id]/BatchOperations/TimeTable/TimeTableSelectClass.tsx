...
const TimeTableSelectClass = ({ params, searchParams, data }: { params: any, searchParams: any, data: any }) => {
    ...
    const Columns: TableColumn<EdgeClassRoom>[] = [
        ...
        { header: "Academic Year", accessor: "node.academicYear", align: "center" },
        {
            ...
            render: (item) => <button
                onClick={() => router.push(`/${params.domain}/Section-S/pageAdministration/${params.school_id}/BatchOperations/TimeTable/?class=${item.node.id}&type=timetable`)}
...
export default TimeTableSelectClass;
