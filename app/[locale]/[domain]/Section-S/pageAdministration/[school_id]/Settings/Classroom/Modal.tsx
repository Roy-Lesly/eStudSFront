...
const Modal = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
      const totalPayments = parseInt(formData.paymentOne) + parseInt(formData.paymentTwo) + parseInt(formData.paymentThree);
  
    if (totalPayments !== parseInt(formData.tuition)) {
      alert('The total of installments must equal the tuition amount.');
      return;
    }
    ...
    const newFormData = {
      ...
      tuition: totalPayments,  // You might want to use the sum here, or leave tuition as it was
