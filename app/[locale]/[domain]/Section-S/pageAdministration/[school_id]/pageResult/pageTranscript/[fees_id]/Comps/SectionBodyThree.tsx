...
const SectionBodyThree = ({ results }: { results: SemesterResults }) => {
  ...
  return (
    <View style={[styles.body, styles.borderedBox, { borderRadius: 4, width: "100%" }]}>
      ...
      >
        {results?.academicYear} - {results?.level} - Semester: {results?.semester} - GPA: {results?.semesterGPA}
      </Text>
...
export default SectionBodyThree;
