...
import { TypeTransSchoolInfo } from "@/utils/Domain/schemas/interfaceGraphqTranscript";
import { View, Text, StyleSheet, Image } from "@react-pdf/renderer";


const SectionHeaderOne = ({ info, params }: { info: TypeTransSchoolInfo, params: any }) => {
  ...
  return (
    <View style={{ height: "41.67%", flexDirection: "row", width: "100%",  }}>
      ...
      <View style={[styles.headerRight, { width: "41%", gap: 4 }]}>
        ...
        <Text style={styles.headerSubText}>{info?.ministry}</Text>
      </View>
    </View>
  );
};
