...
import SectionHeaderTwo from './BatchSectionHeaderTwo';
import SectionBodyTwo from './BatchSectionBodyTwo';
import SectionInfoTwo from './BatchSectionInfoTwo';
import SectionFooterTwo from './BatchSectionFooterTwo';



const TransTwoYear = ({ dataResult, dataHeader, params }: { dataResult: ResultDataSpecialtyTranscript[], params: any, dataHeader: SpecialtyAndSchoolInfo }) => {
        ...
        {dataResult?.map((studentData: ResultDataSpecialtyTranscript, index: number) => (
            ...
            >
                ...
                <View style={styles.header}>
                    ...
                    <SectionHeaderTwo info={dataHeader} params={params} />
                ...
                <View style={{ height: "32.6%", flexDirection: "row", gap: 1, paddingHorizontal: 5 }}>
                    <SectionBodyTwo results={studentData?.results?.filter((item: ResultTranscript) => item.semester === "I")} semester="I" />
                    <SectionBodyTwo results={studentData?.results?.filter((item: ResultTranscript) => item.semester === "I")} semester="I" />
                </View>
                
                <View style={{ height: "32.7%", flexDirection: "row", gap: 1, paddingHorizontal: 5 }}>
                    <SectionBodyTwo results={studentData?.results?.filter((item: ResultTranscript) => item.semester === "II")} semester="II" />
                    <SectionBodyTwo results={studentData?.results?.filter((item: ResultTranscript) => item.semester === "II")} semester="II" />
                </View>
